...
* bucket_size: bucket의 크기
* size: 현재 hash table에 들어있는 entry 들의 수
...
extern void hashInitialize(HashTable* hash, int bucket_size, int(*hash_func)(void*), int(*cmp)(void*, void*));
extern void hashRelease(HashTable*  hash);
